...
import { cloneDeliveryShipment } from "../../pages/cloneDeliveryShipment";
...
const cloneDeliveryShipmentObj=new cloneDeliveryShipment();
...
describe('Shipment Tests', () => {
    ...
    it('Should Clone a Direct Delivery Type of shipment', () => {
        ...
        cloneDeliveryShipmentObj.searchDeliveryShipmentbyType();
